...
class TestArakoonInstaller(TestCase):
    ...
    def test_single_node(self):
        ...
        result = ArakoonInstaller.create_cluster(TestArakoonInstaller.cluster_name, 'FWK', node, '/tmp/db')
    ...
    def test_multi_node(self):
        ...
        result = ArakoonInstaller.create_cluster(TestArakoonInstaller.cluster_name, 'FWK', first_node, '/tmp/db')
