...
class FilesystemConfig(GenericConfig):
    def __init__(self, fs_dtl_host=None, fs_dtl_port=None, fs_dtl_mode=None, fs_ignore_sync=None, fs_max_open_files=None, fs_cache_dentries=None, fs_raw_disk_suffix=None,
                 fs_dtl_config_mode=None, fs_file_event_rules=None, fs_virtual_disk_format=None, fs_enable_shm_interface=None, fs_metadata_backend_type=None,
                 ...
                 fs_metadata_backend_arakoon_cluster_nodes= None, fs_metadata_backend_mds_slave_max_tlogs_behind=None, fs_metadata_backend_mds_apply_relocations_to_slaves=None, **kwargs):
        """
