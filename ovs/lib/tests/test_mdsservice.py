...
class MDSServices(TestCase):
    ...
    def _create_vdisks_for_mds_service(self, mds_service, amount, start_id):
        """
    ...
    def test_storagedriver_config_set(self):
        ...
        for mds_service in mds_services.itervalues():
            vdisks.update(self._create_vdisks_for_mds_service(mds_service, 10, start_id))
            start_id += 10
