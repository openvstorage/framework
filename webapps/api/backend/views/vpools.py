...
class VPoolViewSet(viewsets.ViewSet):
    ...
    def update_storagedrivers(self, vpool, storagedriver_guid, storagerouter_guids=None, storagedriver_guids=None):
        ...
        parameters = {'connection_host': None if vpool.connection is None else vpool.connection.split(':')[0],
                      ...
                      'mountpoint_bfs': storagedriver.mountpoints['bfs'],
                      'mountpoint_temp': storagedriver.mountpoints['tmp'],
                      'mountpoint_md': storagedriver.mountpoints['md'],
                      'mountpoint_readcaches': storagedriver.mountpoint_readcaches,
                      'mountpoint_writecaches': storagedriver.mountpoint_writecaches,
                      'mountpoint_foc': storagedriver.mountpoints['dtl'],
