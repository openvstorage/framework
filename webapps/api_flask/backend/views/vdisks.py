...
@log()
@view.route('/')
def list(vpoolguid=None, storagerouterguid=None):
    """
...
@log()
@view.route('/<vdisk_guid>')
def retrieve(vdisk_guid):
    """
    Load information about a given vDisk
    :param vdisk_guid: Guid of the virtual disk to retrieve
    :type vdisk_guid: VDisk
...
@log()
# @required_roles(['read', 'write'])
def move(vdisk, target_storagerouter_guid, force=False):
    """
    Moves a vDisk
