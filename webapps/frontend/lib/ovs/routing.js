...
define(['jquery'], function($) {
    ...
    siteRoutes = [
        ...
        { route: 'storageappliances',       moduleId: 'storageappliances',       title: $.t('ovs:storageappliances.title'),        titlecode: 'ovs:storageappliances.title',        nav: true,  main: true  },
        { route: 'storageappliances/:guid', moduleId: 'storageappliance-detail', title: $.t('ovs:storageappliances.detail.title'), titlecode: 'ovs:storageappliances.detail.title', nav: false, main: false },
