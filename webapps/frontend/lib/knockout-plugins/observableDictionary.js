...
// Added requireJS support by and some bug fixing engineering@openvstorage.com
...
(function (factory) {
    ...
    ko.observableDictionary['fn'] = {
        // Variables
        isObservableDictionary: true,  // Add possibility to detecting the type
        // Functions
        ...
        contains: function (key) {  // Returns indexOf but in boolean
