            ...
            return $.Deferred(function(deferred) {
                var postData = {
                    call_parameters: {
                        ...
                        cache_quota_fc: self.data.useFC() === true && self.data.cacheQuotaFC() !== undefined && self.data.cacheQuotaFC() !== '' ? self.formatFloat(self.data.cacheQuotaFC() * Math.pow(1024.0, 3)) : undefined,
                        cache_quota_bc: self.data.useBC() === true && self.data.cacheQuotaBC() !== undefined && self.data.cacheQuotaBC() !== '' ? self.formatFloat(self.data.cacheQuotaBC() * Math.pow(1024.0, 3)) : undefined,
