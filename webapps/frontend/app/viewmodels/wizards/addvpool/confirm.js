                ...
                var post_data = {
                    call_parameters: {
                        ...
                        connection_backend: {'backend': (self.data.backend() === 'alba' && self.data.albaBackend() !== undefined ? self.data.albaBackend().guid : undefined),
                                             'preset_info': (self.data.backend() === 'alba' && self.data.albaPreset() !== undefined ? self.data.albaPreset() : undefined),
                                             'metadata': (self.data.backend() === 'alba' && self.data.albaBackend().metadataInformation() !== undefined ? self.data.albaBackend().metadataInformation() : undefined)},
