...
define([
    ...
    return function(guid) {
        ...
        self.storageApplianceHandle = undefined;
        ...
        self.loadStorageAppliances = function() {
            return $.Deferred(function(deferred) {
                if (generic.xhrCompleted(self.storageApplianceHandle)) {
                    self.storageApplianceHandle = api.get('vpools/' + self.guid() + '/storageappliances')
                        .done(function(data) {
                            self.storageApplianceGuids(data);
                            deferred.resolve();
                        })
                        .fail(deferred.reject);
                } else {
